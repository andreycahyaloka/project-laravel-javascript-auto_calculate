...
// auto calculate
	...
	function calc() {
		document.autoSumForm.result_value.value = 0;

		fir_val = document.autoSumForm.first_value.value;
		sec_val = document.autoSumForm.second_value.value;

		result1 = ((fir_val*1) + (sec_val*1)) / 2;
		result2 = result1.toFixed(2);

		document.autoSumForm.result_value.value = result2;
	}
	function stopCalc() {
